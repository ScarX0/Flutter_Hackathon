        ...
        body: SingleChildScrollView(
          child: Container(
            margin: EdgeInsets.symmetric(
                horizontal: WidthSize * 0.05, vertical: HeightSize * 0.05),
            child: Column(
              children: [
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: FilterChip(
                        padding: EdgeInsets.only(bottom: HeightSize * 0.01332),
                        selectedColor: const Color(0xff582e44),
                        showCheckmark: false,
                    ...
                    Container(
                      ...
                      child: FilterChip(
                        ...
                        label: Text(
                          '  المقبلة  ',
                          style: TextStyle(
                              color: entree ? Colors.white : Colors.black),
                        ),
                        selected: entree,
                        onSelected: (bool value) {
                          setState(() {
